...
public class AdminsController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest req) {
        return adminRepository.findByEmail(req.email).map(admin -> {
            if (admin.password != null && passwordEncoder.matches(req.password, admin.password)) {
                ...
                LoginResponse.AdminInfo info = new LoginResponse.AdminInfo(admin.id, admin.email, admin.admin);
    ...
    public static class LoginResponse {
        ...
        public static class AdminInfo {
            ...
            public AdminInfo(Long id, String email, boolean admin) {
                this.id = id;
                this.email = email;
                this.admin = admin;
            }
        ...
        public LoginResponse(String token, AdminInfo admin) {
            this.token = token;
            this.admin = admin;
        }
    }
